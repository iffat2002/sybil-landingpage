...
const Navbar = () => {
  ...
  return (
    <nav className="w-full  bg-gradient-orange ">
      <div className="w-11/12 m-auto flex justify-between h-[105px] items-center ">
        <Image
          src="/logo.svg"
          alt="website logo"
          width={155}
          height={57}
        ></Image>
        <ul className="flex gap-3 font-semibold max-md:hidden">
          <Link href="/">
            <li>FAQ</li>
          </Link>
          <Link href="/">
        ...
        <button className="font-semibold bg-[#7dd3fc] rounded-full w-[186px] h-[48px] max-md:hidden">
          Get Sybil Now
          <svg
        ...
        <div className="hidden max-md:block border-[#60cde8bb] p-[7px] border w-10 h-10 hover:bg-[#d4e6eb62] rounded-md cursor-pointer" onClick={handleClick}>
      ...
      {NavbarClicked && <div className="relative z-30 w-screen h-44 bg-inherit text-center"> <ul className="flex flex-col gap-3 font-semibold">
          <Link href="/">
            <li>FAQ</li>
          </Link>
          <Link href="/">
